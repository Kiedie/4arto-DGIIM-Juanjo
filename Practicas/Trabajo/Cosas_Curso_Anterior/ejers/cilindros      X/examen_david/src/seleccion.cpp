...
bool Seleccion( int x, int y, Escena * escena, ContextoVis & cv_dib )
{
   ...
   if(id_pix>=10 and id_pix<255) // identificadores reservados para cilindros
	   cout << "has pinchado en uno de los cilindros, concretamente en el número " << id_pix-10 << endl;
