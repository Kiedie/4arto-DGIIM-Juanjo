...
class MallaInd : public Objeto3D
{
   ...
   protected:
      ...
      //Caja y circunferencias
      std::vector<Tupla3f> ver_caja;
      
      std::vector<Tupla3f> cicX;
      std::vector<Tupla3f> cicY;
      std::vector<Tupla3f> cicZ;
      
      GLuint
         id_vbo, id_vao= 0;
      
      void calcularVerticesCaja();
      void calcularCircunferencias(const int n);
      Tupla3f centro();

      void visualizarGL_caja(ContextoVis & cv);
      void visualizarGL_circ(ContextoVis & cv);
